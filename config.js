...
const AppConfig = {
    ...
    // 關鍵變更：將同一個 LIFF ID 用於所有頁面，但給予不同別名以利區分
    LIFF_ID_INDEX: '2008135811-vNO5bYyx',    // 首頁 (index.html)
    LIFF_ID_COURSES: '2008135811-vNO5bYyx',  // 課程預約 (courses.html)
    LIFF_ID_SCHEDULE: '2008135811-vNO5bYyx', // 時段選擇 (schedule.html)
