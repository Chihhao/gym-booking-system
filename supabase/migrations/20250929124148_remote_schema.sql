...
CREATE UNIQUE INDEX classes_pkey ON public.classes USING btree (class_id);
...
CREATE UNIQUE INDEX users_pkey ON public.users USING btree (line_user_id);
...
alter table "public"."bookings" add constraint "bookings_class_id_fkey" FOREIGN KEY (class_id) REFERENCES classes(class_id) ON DELETE CASCADE not valid;

alter table "public"."bookings" validate constraint "bookings_class_id_fkey";

alter table "public"."bookings" add constraint "bookings_line_user_id_fkey" FOREIGN KEY (line_user_id) REFERENCES users(line_user_id) ON DELETE CASCADE not valid;

alter table "public"."bookings" validate constraint "bookings_line_user_id_fkey";

alter table "public"."classes" add constraint "classes_coach_id_fkey" FOREIGN KEY (coach_id) REFERENCES coaches(coach_id) ON DELETE RESTRICT not valid;

alter table "public"."classes" validate constraint "classes_coach_id_fkey";

alter table "public"."classes" add constraint "classes_course_id_fkey" FOREIGN KEY (course_id) REFERENCES courses(course_id) ON DELETE RESTRICT not valid;

alter table "public"."classes" validate constraint "classes_course_id_fkey";

alter table "public"."classes" add constraint "students_check" CHECK ((current_students <= max_students)) not valid;

alter table "public"."classes" validate constraint "students_check";
